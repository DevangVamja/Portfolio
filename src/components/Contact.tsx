...
const channels = [
  {
    ...
    description:
      "Let’s talk data pipelines, cloud ETL, or your next engineering challenge.",
  },
  {
    ...
    description:
      "Browse pipeline builds, ETL utilities, and engineering-focused projects.",
  },
  {
    ...
    description:
      "Connect for data engineering roles, collaborations, or technical discussions.",
  },
];
...
export default function Contact() {
  ...
  return (
    <section id="contact" className="relative overflow-hidden py-24">
      <div
        className={`absolute inset-0 bg-gradient-to-br ${theme.contact.gradient}`}
      />
      ...
      <div className="container relative mx-auto px-6">
        <Reveal className="mx-auto max-w-2xl text-center text-white">
          ...
          <p
            className={`mt-4 text-base md:text-lg ${theme.contact.accentText}`}
          >
            I&apos;m always excited to connect with teams and creators building
            scalable, data-driven systems and analytics platforms.
          </p>
        </Reveal>
            ...
            <Reveal key={channel.label} delay={index * 120}>
              ...
              >
                <div>
                  ...
                  <p
                    className={`mt-4 text-sm ${theme.contact.accentMutedText}`}
                  >
                    {channel.description}
                  </p>
                </div>
                <span
                  className={`mt-6 inline-flex items-center text-sm font-semibold transition group-hover:text-white ${theme.contact.callToAction}`}
                >
                  Get in touch
                </span>
              </a>
