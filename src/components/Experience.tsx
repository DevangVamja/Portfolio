        ...
        <div className="relative mx-auto mt-14 max-w-5xl border-l border-white/10 pl-8 md:pl-12">
          ...
          {experiences.map((exp, index) => (
            <Reveal key={exp.title} delay={index * 120} className="relative pb-12 last:pb-0">
              <div
                className={`absolute -left-[37px] top-1.5 flex h-12 w-12 items-center justify-center rounded-full border text-white md:-left-[45px] ${theme.experience.timelineRing} ${theme.experience.shadow}`}
              >
